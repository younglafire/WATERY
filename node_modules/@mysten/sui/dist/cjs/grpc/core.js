...
class GrpcCoreClient extends import_experimental.Experimental_CoreClient {
  ...
  async getAllBalances(options) {
    ...
    return {
      ...
      cursor: result.response.nextPageToken ? (0, import_utils.toBase64)(result.response.nextPageToken) : null,
  ...
  async defaultNameServiceName(options) {
    const name = (await __privateGet(this, _client).nameService.reverseLookupName({
  ...
  async getMoveFunction(options) {
    ...
    switch (response.function?.visibility) {
      case import_move_package.FunctionDescriptor_Visibility.PUBLIC:
        visibility = "public";
        break;
      case import_move_package.FunctionDescriptor_Visibility.PRIVATE:
        visibility = "private";
        break;
      case import_move_package.FunctionDescriptor_Visibility.FRIEND:
        visibility = "friend";
        break;
    }
    return {
      function: {
        ...
        typeParameters: response.function?.typeParameters?.map(({ constraints }) => ({
          ...
          constraints: constraints.map((constraint) => {
            switch (constraint) {
              case import_move_package.Ability.COPY:
                return "copy";
              case import_move_package.Ability.DROP:
                return "drop";
              case import_move_package.Ability.STORE:
                return "store";
              case import_move_package.Ability.KEY:
                return "key";
              default:
                return "unknown";
            }
...
function mapIdOperation(operation) {
  ...
  switch (operation) {
    case import_effects2.ChangedObject_IdOperation.CREATED:
      return "Created";
    case import_effects2.ChangedObject_IdOperation.DELETED:
      return "Deleted";
    case import_effects2.ChangedObject_IdOperation.NONE:
    case import_effects2.ChangedObject_IdOperation.ID_OPERATION_UNKNOWN:
      return "None";
    default:
      operation;
      return "Unknown";
...
function mapInputObjectState(state) {
  ...
  switch (state) {
    case import_effects2.ChangedObject_InputObjectState.EXISTS:
      return "Exists";
    case import_effects2.ChangedObject_InputObjectState.DOES_NOT_EXIST:
      return "DoesNotExist";
    case import_effects2.ChangedObject_InputObjectState.UNKNOWN:
      return "Unknown";
    default:
      state;
      return "Unknown";
...
function mapOutputObjectState(state) {
  ...
  switch (state) {
    case import_effects2.ChangedObject_OutputObjectState.OBJECT_WRITE:
      return "ObjectWrite";
    case import_effects2.ChangedObject_OutputObjectState.PACKAGE_WRITE:
      return "PackageWrite";
    case import_effects2.ChangedObject_OutputObjectState.DOES_NOT_EXIST:
      return "DoesNotExist";
    case import_effects2.ChangedObject_OutputObjectState.UNKNOWN:
      return "Unknown";
    default:
      state;
      return "Unknown";
...
function mapUnchangedConsensusObjectKind(kind) {
  ...
  switch (kind) {
    case import_effects.UnchangedConsensusObject_UnchangedConsensusObjectKind.UNCHANGED_CONSENSUS_OBJECT_KIND_UNKNOWN:
      return "Unknown";
    case import_effects.UnchangedConsensusObject_UnchangedConsensusObjectKind.READ_ONLY_ROOT:
      return "ReadOnlyRoot";
    case import_effects.UnchangedConsensusObject_UnchangedConsensusObjectKind.MUTATE_CONSENSUS_STREAM_ENDED:
      return "MutateConsensusStreamEnded";
    case import_effects.UnchangedConsensusObject_UnchangedConsensusObjectKind.READ_CONSENSUS_STREAM_ENDED:
      return "ReadConsensusStreamEnded";
    case import_effects.UnchangedConsensusObject_UnchangedConsensusObjectKind.CANCELED:
      return "Cancelled";
    case import_effects.UnchangedConsensusObject_UnchangedConsensusObjectKind.PER_EPOCH_CONFIG:
...
function parseNormalizedSuiMoveType(type) {
  let reference = null;
  if (type.reference === import_move_package.OpenSignature_Reference.IMMUTABLE) {
    reference = "immutable";
  } else if (type.reference === import_move_package.OpenSignature_Reference.MUTABLE) {
    reference = "mutable";
  }
  return {
    reference,
...
function parseNormalizedSuiMoveTypeBody(type) {
  switch (type.type) {
    case import_move_package.OpenSignatureBody_Type.TYPE_UNKNOWN:
      return { $kind: "unknown" };
    case import_move_package.OpenSignatureBody_Type.ADDRESS:
      return { $kind: "address" };
    case import_move_package.OpenSignatureBody_Type.BOOL:
      return { $kind: "bool" };
    case import_move_package.OpenSignatureBody_Type.U8:
      return { $kind: "u8" };
    case import_move_package.OpenSignatureBody_Type.U16:
      return { $kind: "u16" };
    case import_move_package.OpenSignatureBody_Type.U32:
      return { $kind: "u32" };
    case import_move_package.OpenSignatureBody_Type.U64:
      return { $kind: "u64" };
    case import_move_package.OpenSignatureBody_Type.U128:
      return { $kind: "u128" };
    case import_move_package.OpenSignatureBody_Type.U256:
      return { $kind: "u256" };
    case import_move_package.OpenSignatureBody_Type.VECTOR:
      return {
        $kind: "vector",
        vector: parseNormalizedSuiMoveTypeBody(type.typeParameterInstantiation[0])
      };
    case import_move_package.OpenSignatureBody_Type.DATATYPE:
      return {
        $kind: "datatype",
        datatype: {
    ...
    case import_move_package.OpenSignatureBody_Type.TYPE_PARAMETER:
      return {
        $kind: "typeParameter",
